...
const QUICK_LINKS = [
  ...
  { label: "Khabri Trends", href: "/m/khabri/trends", icon: Newspaper },
  { label: "Khabri Signals", href: "/m/khabri/signals", icon: Newspaper },
  { label: "Khabri Narratives", href: "/m/khabri/narratives", icon: Newspaper },
  { label: "Khabri Geo Intel", href: "/m/khabri/geo", icon: Newspaper },
