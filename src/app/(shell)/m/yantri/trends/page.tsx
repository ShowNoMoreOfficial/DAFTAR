...
export default function TrendsPage() {
  ...
  useEffect(() => {
    fetch("/api/yantri/trends/batches")
      .then((r) => r.json())
      .then(setBatches);
  }, []);
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      {batch.trends.length} trends &mdash; {selectedCount} selected, {skippedCount} skipped
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {hasNarratives && (
                      <Button
                        ...
                        onClick={async (e) => {
                          ...
                          await fetch(`/api/yantri/trends/batch/${batch.id}`, { method: "PUT" });
                          const res = await fetch("/api/yantri/trends/batches");
                    ...
                    <Button
                      ...
                      onClick={async (e) => {
                        ...
                        await fetch(`/api/yantri/trends/batch/${batch.id}`, { method: "DELETE" });
