  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="w-8 h-8 bg-[rgba(236,72,153,0.1)]0/10 rounded-lg flex items-center justify-center">
        ...
        <div className="space-y-4">
              ...
              <div className="space-y-2">
                {content.text_overlays.map((overlay, i) => (
                  <div key={i} className="flex items-center gap-3 bg-zinc-900 rounded-lg p-3">
                    <Badge variant="outline" className="bg-[rgba(236,72,153,0.1)]0/10 text-pink-400 border-pink-500/20 text-[9px] font-black shrink-0">
                      {overlay.time}
                    </Badge>
          ...
          <Card className="rounded-xl border-border p-5 bg-emerald-950/20 border-emerald-500/20">
            <div className="flex items-center gap-2 mb-3">
              ...
              <Badge variant="outline" className="bg-[rgba(16,185,129,0.1)]0/10 text-emerald-400 border-emerald-500/20 text-[9px] font-black ml-auto">
                ElevenLabs
              </Badge>
            </div>
            {voiceover ? (
            ...
            {content.slides.map((slide) => (
              <div key={slide.position} className="bg-zinc-900 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {slide.position === 1 && (
                    <Badge variant="outline" className="bg-[rgba(236,72,153,0.1)]0/10 text-pink-400 border-pink-500/20 text-[9px]">
                      HOOK
                    </Badge>
                  )}
                </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1">
                {postingPlan.hashtags.map((tag, i) => (
                  <Badge key={i} variant="secondary" className="bg-[rgba(236,72,153,0.1)]0/10 text-pink-400 border-none text-xs">
                    {tag}
                  </Badge>
                ))}
              </div>
