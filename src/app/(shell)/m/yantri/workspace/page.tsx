...
const PIPELINE_COLUMNS = [
  ...
  { id: "DRAFTED", label: "Review", icon: Eye, color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20" },
      ...
      <div className="flex items-center justify-between mb-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            onClick={() => window.location.href = "/m/khabri/signals"}
          >
...
function PipelineCard({
  ...
  return (
    <Card className="border-[var(--border-subtle)] bg-[var(--bg-deep)] hover:border-[var(--accent-primary)]/30 transition-colors group">
        ...
        <div className="flex items-center gap-1 pt-1 opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          {column === "PLANNED" && (
            <Button
              ...
              onClick={() => onAction(item.id, "retrigger")}
            >
          ...
          {item.tree && (
            <Button
              ...
              onClick={() => window.location.href = `/m/yantri/narrative-trees/${item.tree!.id}`}
            >
