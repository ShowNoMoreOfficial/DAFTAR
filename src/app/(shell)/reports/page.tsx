    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-[var(--text-muted)]">View generated organizational reports</p>
        </div>
      ...
      {loading ? (
        <p className="py-12 text-center text-sm text-[var(--text-muted)]">Loading reports...</p>
      ) : reports.length === 0 ? (
        <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-8 text-center">
          ...
          <h3 className="mt-4 text-sm font-medium text-[var(--text-primary)]">No Reports Yet</h3>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {reports.map((report) => (
            <div key={report.id} className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-4 transition-shadow hover:shadow-md">
